...
module.exports.validate_writeable_directory = function(dir) {
  ...
  var uid = process.getuid ? process.getuid() : null;
  var gid = process.getgid ? process.getgid() : null;
  var can_write = ((uid === stat.uid) && (stat.mode & 00200)) || // User is owner and owner can write.
                  ((gid === stat.gid) && (stat.mode & 00020)) || // User is in group and group can write.
